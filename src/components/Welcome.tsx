...
const Welcome = ({nextStep}:propType) => {
  return (
    ...
    className='flex  items-center justify-center gap-10 mt-10'
     ...
     <ShoppingBasket className='w-21 h-24 md:w-32 md:h-32 text-green-600 drop-shadow-md' />
     <Bike  className='w-21 h-24 md:w-32 md:h-32 text-orange-600 drop-shadow-md'/>
      </motion.div>
