...
import { ArrowRight, EyeIcon, EyeOff, Leaf, Loader2, Lock, LogIn, Mail, UserPlus } from 'lucide-react'
...
const Login = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen px-6 py-10 relative overflow-hidden bg-gradient-to-br from-green-50 via-emerald-50 to-white">
      ...
      <motion.div
        className="absolute top-0 right-0 w-96 h-96 bg-green-200/20 rounded-full blur-3xl"
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        >
          <form onSubmit={handleLogin} className="flex flex-col gap-4">
            ...
            >
              <span className="text-xs text-green-600 font-medium hover:underline cursor-pointer transition-all duration-300">
                Forgot password?
              </span>
            </motion.div>
            ...
            <motion.button
              ...
              className={`w-full font-bold py-3.5 rounded-xl transition-all duration-300 shadow-lg inline-flex items-center justify-center gap-2 mt-1 ${
                formValidation
